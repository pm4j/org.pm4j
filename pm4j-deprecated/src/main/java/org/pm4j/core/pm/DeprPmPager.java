...
import org.pm4j.core.pm.pageable.DeprPageableCollection;
...
public interface DeprPmPager {
   ...
   */
  void setPageableCollection(DeprPageableCollection<?> pageableCollection);
