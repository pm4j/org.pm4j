 ...
 * @author olaf boede
 *
 * @deprecated please use {@link PageableCollectionUtil}.
 */
@Deprecated
public final class DeprPageableCollectionUtil {
   ...
   */
  public static int getIdxOfFirstItemOnPage(DeprPageableCollection<?> pageable) {
   ...
   *         Is zero if there are no items in this set.
   */
  public static int getIdxOfLastItemOnPage(DeprPageableCollection<?> pageable) {
    int pageSize = pageable.getPageSize();
    return (pageable.getNumOfItems() > 0)
            ? Math.min(
  ...
  /**
   *
   * @param pageable The {@link DeprPageableCollection} to evaluate.
   ...
   */
  public static int getPageForItemPos(DeprPageableCollection<?> pageable, int itemPos) {
    int pageSize = pageable.getPageSize();
   ...
   */
  public static int getNumOfPages(DeprPageableCollection<?> pageable) {
   ...
   *          The set to handle.
   */
  public static void navigateToPrevPage(DeprPageableCollection<?> pageable) {
   ...
   *          The set to handle.
   */
  public static void navigateToNextPage(DeprPageableCollection<?> pageable) {
    int currentPageIdx = pageable.getCurrentPageIdx();
   ...
   *          The set to handle.
   */
  public static void navigateToFirstPage(DeprPageableCollection<?> pageable) {
    int currentPageIdx = pageable.getCurrentPageIdx();
    if (currentPageIdx > 1) {
   ...
   *          The set to handle.
   */
  public static void navigateToLastPage(DeprPageableCollection<?> pageable) {
    int currentPageIdx = pageable.getCurrentPageIdx();
   ...
   */
  public static boolean hasNextPage(DeprPageableCollection<?> pageable) {
    int currentPageIdx = pageable.getCurrentPageIdx();
   ...
   */
  public static boolean hasPrevPage(DeprPageableCollection<?> pageable) {
  ...
  public static <T> void setAllOnPageSelected(DeprPageableCollection<T> pageable, boolean doSelect) {
   ...
   */
  public static <T> boolean isAllOnPageSelected(DeprPageableCollection<T> pageable) {
  ...
  public static <T> void selectAll(DeprPageableCollection<T> pageable, boolean doSelect) {
