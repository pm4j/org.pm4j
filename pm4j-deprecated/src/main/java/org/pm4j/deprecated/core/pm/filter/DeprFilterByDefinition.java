 ...
 */
@Deprecated
public interface DeprFilterByDefinition {
   ...
   */
  Collection<DeprCompOp> getCompOps();

  /**
   * @return The default compare operator.
   */
  DeprCompOp getDefaultCompOp();
   ...
   *         filter condition.
   */
  boolean isEffectiveFilterItem(DeprCompOp compOp, Object filterValue);
   ...
   */
  boolean doesItemMatch(Object item, DeprCompOp compOp, Object filterValue);
