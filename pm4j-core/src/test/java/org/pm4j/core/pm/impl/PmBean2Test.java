...
public class PmBean2Test {
  ...
  @Test
  public void readBeanPmWithGetterLogicCached() {
    TestPmBase pm = new BeanPmWithGetterLogicCached().provideTestBean(bean);
    assertSame(bean, pm.getPmBean());
    assertEquals(1, pm.callCount_getPmBeanImpl);
    assertSame(bean, pm.getPmBean());
    assertEquals(1, pm.callCount_getPmBeanImpl);
  ...
  public void assignBeanToCachedPmBean() {
    TestPmBase pm = new BeanPmWithGetterLogicCached();
    pm.setPmBean(new Bean("NewBean"));
  }

  @Test
  public void readBeanPmWithGetterLogicCachedNeverCleared() {
    TestPmBase pm = new BeanPmWithGetterLogicCachedNeverCleared().provideTestBean(bean);
    assertSame(bean, pm.getPmBean());
    assertEquals(1, pm.callCount_getPmBeanImpl);
    assertSame(bean, pm.getPmBean());
    assertEquals(1, pm.callCount_getPmBeanImpl);
  ...
  public void assignBeanToFixCachedPmBean() {
    TestPmBase pm = new BeanPmWithGetterLogicCachedNeverCleared();
    pm.setPmBean(new Bean("NewBean"));
  ...
  @PmCacheCfg2(@Cache(property=CacheKind.VALUE))
  public static class BeanPmWithGetterLogicCached extends TestPmBase {
  }

  @PmCacheCfg2(@Cache(property=CacheKind.VALUE, clear=Clear.NEVER))
  public static class BeanPmWithGetterLogicCachedNeverCleared extends TestPmBase {
  }
