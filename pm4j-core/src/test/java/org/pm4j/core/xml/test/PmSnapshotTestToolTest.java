package org.pm4j.core.xml.test;
...
public class PmSnapshotTestToolTest {
  ...
  public void testWriteSnapshot() {
    ...
    assertTrue(path, path.endsWith("pm4j-core/src/test/java/org/pm4j/core/xml/test/pmSnapshotTestToolTest/testWriteSnapshot.xml"));
    try {
