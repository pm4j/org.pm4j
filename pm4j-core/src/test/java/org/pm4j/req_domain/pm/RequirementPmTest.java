...
public class RequirementPmTest extends TestCase {
  ...
  public void testPmEvents() {
    ...
    _RecordingPmEventListener changedStateChangeListener = new _RecordingPmEventListener();
    _RecordingPmEventListener allEventsListener = new _RecordingPmEventListener();
