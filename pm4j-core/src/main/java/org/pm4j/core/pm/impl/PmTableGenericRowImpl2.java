 ...
 * @author olaf boede
 */
public class PmTableGenericRowImpl2<T_ROW_ELEMENT extends PmElement> implements PmTableGenericRow2<T_ROW_ELEMENT> {

  @SuppressWarnings("unused")
  private static final Log LOG = LogFactory.getLog(PmTableGenericRowImpl2.class);

  private final PmTable2<T_ROW_ELEMENT> pmTable;
  private final T_ROW_ELEMENT rowElement;
  private List<PmObject> items;

  public PmTableGenericRowImpl2(PmTable2<T_ROW_ELEMENT> pmTable, T_ROW_ELEMENT pmElement) {
    assert pmTable != null;
  ...
  @Override
  public PmTable2<T_ROW_ELEMENT> getPmTable() {
    return pmTable;
  }
