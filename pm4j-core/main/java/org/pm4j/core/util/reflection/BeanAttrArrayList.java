...
public class BeanAttrArrayList<T> implements List<T> {
  ...
  @Override public boolean add(T e) { throw new PmRuntimeException("not implemented."); }
  @Override public void add(int index, T element) { throw new PmRuntimeException("not implemented."); }
  @Override public boolean addAll(Collection<? extends T> c) { throw new PmRuntimeException("not implemented."); }
  @Override public boolean addAll(int index, Collection<? extends T> c) { throw new PmRuntimeException("not implemented."); }
  @Override public void clear() { throw new PmRuntimeException("not implemented."); }
  ...
  @Override public boolean remove(Object o) { throw new PmRuntimeException("not implemented."); }
  @Override public T remove(int index) { throw new PmRuntimeException("not implemented."); }
  @Override public boolean removeAll(Collection<?> c) { throw new PmRuntimeException("not implemented."); }
  @Override public boolean retainAll(Collection<?> c) { throw new PmRuntimeException("not implemented."); }
  @Override public T set(int index, T element) { throw new PmRuntimeException("not implemented."); }
