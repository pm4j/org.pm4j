...
Many nice UI controls are well supported and you get quickly a visible results of your work.
...
Its hardly possible to write a simple JUnit test covering that logic. You usually need to use a technology specific test framework. +
...
If this is hard to achieve because of mixed view technology and business logic code, this may get a risk for loosing the business logic investments.
...
Here its useful to use a PM framework like pm4j that prevents writing such boiler plate code.__
