...
/**
 * Some common basic implementation code for {@link PageableCollection}.
 *
 * @param <T_ITEM> type of handled collection items.
 *
 * @author olaf boede
 */
public abstract class PageableCollectionBase<T_ITEM> extends PropertyChangeSupportedBase implements PageableCollection<T_ITEM> {
   ...
   */
  public PageableCollectionBase(QueryOptions queryOptions) {
