...
import org.pm4j.common.pageable.querybased.pagequery.PageableQueryServiceWithSerialization.SerializeableServiceProvider;
...
public abstract class PageableQuerySelectionBase<T_ITEM, T_ID> implements Selection<T_ITEM>, Serializable {
  ...
  public PageableQuerySelectionBase(QueryService<T_ITEM, T_ID> service) {
    assert service != null;
