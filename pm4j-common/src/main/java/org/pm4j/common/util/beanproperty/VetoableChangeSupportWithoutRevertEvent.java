...
/**
 * XXX oboede: Quick hack for missing revert event customization.
 * Consider an own implementation to prevent license conflicts.
 * <p>
 * A copy of VetoableChangeSupport that does not fire revert events
 * in case of a listener veto.<br>
 * These revert events don't match the pattern used by {@link PropertyChangeSupportedBase}.
 * There it is expected that no veto event listener performs changes and thus they don't need
 * any revert-event in case of a veto.<br>
 * All changes should only be done by the (non-veto) property event listeners that get called
 * only when all veto listeners already agreed.
 *
 * <p>
...
public class VetoableChangeSupportWithoutRevertEvent implements java.io.Serializable {
    ...
    public VetoableChangeSupportWithoutRevertEvent(Object sourceBean) {
    if (sourceBean == null) {
    ...
    public synchronized VetoableChangeListener[] getVetoableChangeListeners(){
        ...
        if (children != null) {
            ...
            while (iterator.hasNext()) {
                ...
                VetoableChangeSupportWithoutRevertEvent child =
                        (VetoableChangeSupportWithoutRevertEvent)children.get(key);
    ...
    public synchronized void addVetoableChangeListener(
        ...
        VetoableChangeSupportWithoutRevertEvent child = (VetoableChangeSupportWithoutRevertEvent)children.get(propertyName);
        if (child == null) {
            child = new VetoableChangeSupportWithoutRevertEvent(source);
    ...
    public synchronized VetoableChangeListener[] getVetoableChangeListeners(
        ...
        if (children != null && propertyName != null) {
            VetoableChangeSupportWithoutRevertEvent support =
                    (VetoableChangeSupportWithoutRevertEvent)children.get(propertyName);
            if (support != null) {
                returnList.addAll(
    ...
    VetoableChangeSupportWithoutRevertEvent child = null;
    synchronized (this) {
        if (listeners != null) {
            targets = (java.util.Vector) listeners.clone();
        }
        if (children != null && propertyName != null) {
        child = (VetoableChangeSupportWithoutRevertEvent)children.get(propertyName);
        }
    }
...
// XXX oboede: revert events are commented out. See class comment.
